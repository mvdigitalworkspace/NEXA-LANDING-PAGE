...
const productLinks = ['Funciones', 'Precios', 'Actualizaciones']
const supportLinks = [
  { label: 'Centro de Ayuda', href: '#' },
  { label: 'WhatsApp de Ventas', href: '#' },
  { label: 'hola@nexa.com.ar', href: 'mailto:hola@nexa.com.ar' },
]
...
function FacebookIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07c0 6.02 4.39 11.01 10.13 11.93v-8.44H7.08v-3.49h3.05V9.41c0-3.02 1.8-4.69 4.53-4.69 1.31 0 2.68.24 2.68.24v2.97h-1.51c-1.49 0-1.96.93-1.96 1.89v2.25h3.33l-.53 3.49h-2.8V24C19.61 23.08 24 18.09 24 12.07z" />
    </svg>
  )
}
      ...
      <div className="mx-auto max-w-6xl px-6 py-14">
        <div className="grid grid-cols-2 gap-10 md:grid-cols-4">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 max-w-xs text-pretty text-sm leading-relaxed text-slate-400">
              Hecho con amor en Argentina. Revolucionando el presentismo.
            </p>
          </div>
          ...
          {/* Support */}
          <div>
            <h3 className="text-sm font-semibold text-white">Soporte y Contacto</h3>
            <ul className="mt-4 flex flex-col gap-3">
