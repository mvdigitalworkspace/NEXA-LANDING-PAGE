...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 opacity-60 [background-image:radial-gradient(theme(colors.slate.300)_1px,transparent_1px)] [background-size:22px_22px]"
      />
      {/* fade the dots at the bottom */}
      <div
        aria-hidden="true"
      ...
      <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
        ...
        <p className="mt-6 max-w-xl text-pretty text-lg leading-relaxed text-slate-600">
          Nexa permite a tus empleados fichar desde su celular mediante GPS y PIN.
          Olvídate del hardware y automatiza el control de tus sucursales.
        </p>
          ...
          <div className="overflow-hidden rounded-[1.8rem] bg-slate-50">
            <div className="flex flex-col gap-4 p-5 pt-8">
              ...
              <div className="rounded-xl bg-white p-3 shadow-sm">
                <p className="text-[11px] text-slate-500">Estás dentro del rango permitido</p>
                <p className="mt-0.5 text-sm font-semibold text-slate-900">Radio: 50m · GPS activo</p>
              </div>
              ...
              <p className="text-center text-[11px] text-slate-400">08:59 AM · PIN verificado</p>
            </div>
          </div>
        </div>
      </div>
