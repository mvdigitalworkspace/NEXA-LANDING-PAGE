...
const features: Feature[] = [
  {
    ...
    image: 'https://github.com/mvdigitalworkspace/NEXA-IMAGENES/blob/main/GPS.png?raw=true',
    alt: 'Fichaje Geofence',
  },
  {
    icon: Lock,
    eyebrow: 'Seguridad',
    ...
    image: 'https://github.com/mvdigitalworkspace/NEXA-IMAGENES/blob/main/PIN.png?raw=true',
    alt: 'Seguridad por PIN',
  },
  {
    icon: Clock,
    ...
    image: 'https://github.com/mvdigitalworkspace/NEXA-IMAGENES/blob/main/HORARIO.png?raw=true',
    alt: 'Cierres Automáticos',
  },
]
            ...
            >
              ...
              <div className={reversed ? 'md:order-1' : ''}>
                <div className="aspect-video overflow-hidden rounded-2xl">
                  <img src={feature.image} alt={feature.alt} className="w-full h-full object-cover rounded-2xl shadow-sm" />
                </div>
              </div>
            </div>
          )
